...
<div class="hero">
  <div class="hero__background">
    <div class="hero__text">
      <h1 class="hero__title">Harry Tate</h1>
      <span class="hero__strapline">Junior Front-End Web Developer</span>
    </div>
  </div>
</div>
<main>
  <section class="container">
    <div class="profile">
      ...
      <p class="profile__description">
        Hi, my name is Harry and I'm a Junior Front-End Web developer.
        I recently graduated from Nottingham Trent University and am based in the Cambridgeshire area in the UK. I am currently working at a medium size company in Corby, Northamptonshire helping maintain the front-end of their website.
      </p>
    </div>
  </section>
  <section>
    <div class="container">
      <div class="skills">
        <div class="skills__title">
          <h2 class="skills__title-text">Skills</h2>
        </div>
        <div class="row text--center">
          <div class="one-third column">
            <div class="skills__icon"><i class="fab fa-html5"></i></div>
            <h3 class="skills__title">HTML5</h3>
          </div>
          <div class="one-third column">
            <div class="skills__icon"><i class="fab fa-css3-alt"></i>
            </div>
            <h3 class="skills__title">CSS 3</h3>
          </div>
          <div class="one-third column">
            <div class="skills__icon"><i class="fab fa-js"></i></div>
        ...
        <div class="row text--center">
          <div class="one-third column">
            ...
            <h3 class="skills__title">Bootstrap 4</h3>
          </div>
          <div class="one-third column">
            <div class="skills__icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="50" width="50" viewBox="0 0 32 32" fill="#000">
          ...
          <div class="one-third column">
            <div class="skills__icon"><i class="fas fa-tablet-alt"></i></div>
            <h3 class="skills__title">Responsive Web Design</h3>
          </div>
        </div>
        <div class="row text--center">
          <div class="one-third column">
            <div class="skills__icon"><i class="fab fa-git"></i></div>
            <h3 class="skills__title">Git Version Control</h3>
          </div>
          <div class="one-third column">

            <div class="skills__icon"><i class="fab fa-sass"></i></div>
            <h3 class="skills__title">Sass</h3>
          </div>
          <div class="one-third column">
            <div class="skills__icon"><i class="fas fa-graduation-cap"></i></div>
            <h3 class="skills__title">Bsc Degree in Computing</h3>
          </div>
        </div>

        <div class="skills__content">
          <ul class="skills__list">
            <li class="skills__list-item">HTML5 &amp; CSS3</li>
            <li class="skills__list-item">Basic fundamentals of Javascript</li>
            <li class="skills__list-item">Jquery</li>
            <li class="skills__list-item">Responsive web design</li>
            <li class="skills__list-item">Bootstrap 4 Framework</li>
            <li class="skills__list-item">Git version control</li>
            <li class="skills__list-item">BSc degree in Computing</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section>
    <div class="showcase">
      <div class="showcase__title">
        <h2 class="showcase__title-text">Projects</h2>
      </div>
      <div class="showcase__list">
        <div class="showcase__item">
          <img class="showcase__img" src="" alt="">
          <h3 class="showcase__title">Helping Minds</h3>
        </div>
        <div class="showcase__item">
          <img class="showcase__img" src="" alt="">
          <h3 class="showcase__title">Drone Aerial Surveying</h3>
        </div>
      </div>
    </div>
  </section>
  <section>
    <h2>My Story</h2>
    Idea to have a timeline here e.g. <a href="https://www.managers.org.uk/apprenticeships-and-epa/end-point-assessment/journey">My Journey</a>
  </section>
  <section class="contact">
    <h2>Get in touch</h2>
    <a href="tel://+447710544171">07710 544 171</a>
    <a href="https://www.linkedin.com/in/harry-tate-0576a814b/">Linkedin</a>
